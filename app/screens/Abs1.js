...
export default function Abs1({navigation}){
    return(
       
             <View style={{flex:1}}>
             <ImageBackground source={require('../assets/banners/exercises/abs1.gif')} style={styles.image}>
             ...
             <View style={{flexDirection:'row', top:-350}}>
                ...
                <TouchableOpacity style={{marginHorizontal:320,width:400}}>
                    <View>
                     <MaterialIcons onPress={()=>navigation.navigate('Abs2')} name="arrow-forward" size={40} color="#771D98" />
                    </View>
                </TouchableOpacity>
            </View>
