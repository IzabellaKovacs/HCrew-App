        ...
        <SafeAreaView>
            ...
            <View style={{flexDirection:'row', marginTop:15}}>
                ...
                <View style={styles.cardsWrapper}>
                    ...
                    <View style={styles.card} onPress={()=>navigation.navigate('Breakfast')}>
                        <View style={styles.cardImgWrapper}>
                            <Image source={require('../assets/banners/3.jpg')} resizeMode='cover' style={styles.cardImg}/>
                        </View>
                    <View style={styles.cardInfo} >
                        <Text onPress={()=>navigation.navigate('Breakfast')} style={styles.cardTitle}>Breakfast</Text>
                    </View>
                    </View>
                    ...
                    <View style={styles.cardInfo}>
                        <Text onPress={()=>navigation.navigate('Lunch')} style={styles.cardTitle}>Lunch</Text>
                    </View>
                    </View>
                    <View style={styles.card}>
                        <View style={styles.cardImgWrapper}>
                    ...
                    <View style={styles.cardInfo}>
                        <Text onPress={()=>navigation.navigate('Dinner')} style={styles.cardTitle}>Dinner</Text>
                    </View>
                    </View>
                    <View style={styles.card}>
                        <View style={styles.cardImgWrapper}>
                    ...
                    <View style={styles.cardInfo}>
                        <Text onPress={()=>navigation.navigate('Dessert')} style={styles.cardTitle}>Dessert</Text>
                    </View>
                    </View>
