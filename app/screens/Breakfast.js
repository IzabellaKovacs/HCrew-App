            ...
            <View style={{flexDirection:'row', marginTop:15}}>
                ...
                <View style={styles.cardsWrapper}>
                    ...
                    <View style={styles.cardInfo}>
                        <Text style={styles.cardTitle}>Quinoa Pancakes (Vegan + Gluten Free)</Text>
                    </View>
                    </View>
                    <View style={styles.card}>
                        <View style={styles.cardImgWrapper}>
                    ...
                    <View style={styles.cardInfo}>
                        <Text style={styles.cardTitle}>Gluten-Free Vegan Granola</Text>
                    </View>
                    </View>
                    <View style={styles.card}>
                        <View style={styles.cardImgWrapper}>
                    ...
                    <View style={styles.cardInfo}>
                        <Text style={styles.cardTitle}>Vegan Protein Bars</Text>
                    </View>
                    </View>
                    <View style={styles.card}>
                        <View style={styles.cardImgWrapper}>
                    ...
                    <View style={styles.cardInfo}>
                        <Text style={styles.cardTitle}>Gluten-Free Vegan Biscuits</Text>
                    </View>
                    </View>
